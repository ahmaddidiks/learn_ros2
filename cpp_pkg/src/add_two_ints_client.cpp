...
public:
    ...
    {
        RCLCPP_INFO(this->get_logger(), "Service client has been started");

        for(int i=0; i<10; i++) threads_.push_back(std::thread(std::bind(&AddTwoIntsClientNode::callAddTwoIntsService, this, 1, i)));
    }
